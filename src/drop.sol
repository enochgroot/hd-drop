...
contract HDDrop is
    ...
    // ) public view returns (bool) {
    //     bytes32 candidate = _firstn(
    //         keccak256(abi.encodePacked(address(0xBaDA550008541b3a545908387CC7Af56F2694bAA), id, nonce)),
    //         difficulty
    //     );
    //     bytes32 target = _firstn(
    //         bytes32(uint256(address(0xBaDA550008541b3a545908387CC7Af56F2694bAA)) << 96),
    //         difficulty
    //     );
    //     return (candidate == target);
    // }
